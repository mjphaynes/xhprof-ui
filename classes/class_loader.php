<?php
/**
 * A <tt>Class_Loader</tt> is an autoloader for class files that can be
 * installed on the SPL autoload stack. It is a class loader that either loads only classes
 * of a specific namespace or all namespaces and it is suitable for working together
 * with other autoloaders in the SPL autoload stack.
 * 
 * If no include path is configured through the constructor or {@link setIncludePath}, a Class_Loader
 * relies on the PHP <code>include_path</code>.
 * 
 * @author Doctrine - See Doctrine/Common/ClassLoader.php
 */
class Class_Loader {
    ...
    /**
     * Creates a new <tt>Class_Loader</tt> that loads classes of the
